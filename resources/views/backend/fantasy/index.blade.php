...
<!-- Begin Page Content -->
        <div class="row my-5">
                  ...
                  <div class="tab-content p-2" id="myTabContent">
                    <div class="tab-pane fade show active" id="rule" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <ul id="tab-content">
                            ...
                            <li>
                                Pemain mendaftarkan diri di aplikasi Laliga Fantasy Marca atau di web <a href="https://www.laligafantasymarca.com/" target="_blank" rel="noopener noreferrer">https://www.laligafantasymarca.com/</a> dan sudah memiliki tim aktif.
                            </li>
            ...
            <div class="col-md-auto text-center">
              <a id="ctaLeague" href="{{Route('fantasy.code')}}" class="btn btn-primary">Lihat Kode Liga</a>
            </div>
        </div>
<!-- /.container-fluid -->
@endsection