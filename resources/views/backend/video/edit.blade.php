...
<form method="POST" action="{{route('mvideo.update', $video->id)}}" enctype="multipart/form-data" id="addArticle">
    @csrf
    @method('PATCH')
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror"
                    type="text">{{ $video->description }}}</textarea>
                @error('description')
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <select class="form-control chosen-select" multiple="multiple" name="categories[]">
                    ...
                    <option value="{{$cat->id}}" @foreach ($video->category as $value)
                        @if($cat->id == $value->id)
                        selected
                        @endif
                        @endforeach
            ...
            <div class="form-group mb-3">
                ...
                <div class="custom-file">
                    <input type="file" class="custom-file-input" name="cover" id="cover"  accept="image/png, image/jpeg, image/jpg" 
                        onchange="previewImg()">
            ...
            <div class="form-group">
                ...
                <img src="{{ asset($video->cover) }}" alt="" class="img-thumbnail" id="img-preview">
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="custom-file">
                    <input type="file" class="custom-file-input" name="media" id="file-input"  accept="video/mp4" onchange="previewVideo()">
                ...
                <div class="row">
                    <div class="col">
                        <select class="form-control" name="isPublished" id="isPublished">
                            ...
                            <option value="0">Set as Draft</option>
                            @else
                            <option value="1">Publish</option>
                            <option value="0" selected>Set as Draft</option>
                            @endif
                        </select>
                    </div>
                    <div class="col">
