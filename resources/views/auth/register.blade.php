...
<div class="container" id="regPage">
    <div class="row justify-content-center my-5">
        <div class="col-md-8">
            <div class="card">
                <h2 class="card-header">{{ __('Daftar Akun') }}</h2>
                <div class="row">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label @error('isAggree') is-invalid @enderror" for="isAggree"><small>Dengan mendaftar sebagai pengguna, saya setuju dengan Syarat & Kebijakan Pengguna</small></label>
                            @error('isAggree')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
